...
function isAuthorized(req, res, next) {
    if (typeof req.headers.authorization !== "undefined") {
        ...
        //token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJib2R5Ijoic3R1ZmYiLCJpYXQiOjE1ODYxOTQ0Mjd9.dm1cuawnnZVin7DIhHeK0DVg8CaERrfHgPwjWX9S8XQ";
        let privateKey = fs.readFileSync('./private.pem', 'utf8');
        ...
        jwt.verify(token, privateKey, { algorithm: "HS256" }, (err, user) => {
            ...
            if (err) {
                // shut them out!
                res.status(500).json({ error: "Not Authorized 1" });
            }
        ...
        res.status(500).json({ error: "Not Authorized 2" });
    }
}
